<?php
 if(isset($_POST['submit'])){
   ...
   include_once('../config.php');
    ...
    $result = mysqli_query($conexao, "INSERT INTO epi(NomeEPI,CodigoEPI,QuantidadeEPI,DescriçaoEPI) VALUES('$NomeEPI','$CodigoEPI','$QuantidadeEPI','$DescriçaoEPI')");
}
?>
...
<div class="top-bar">
    ...
    <div class="cadastroEPI">
        ...
        <form class="formulario" method="POST" action="EPI.php">
        
            <h2 class="titulo">Cadastro de EPI</h2>
            <label class="label">
                
                <input type="text" name="NomeEPI" id="NomeEPI" class="input-bordas" placeholder="Nome EPI" required="">
            ...
            <label class="label">
                ...
                <input type="number" formControlName="sGPTypeDeliveryId" name="CodigoEPI" id="CodigoEPI" class="input-bordas" placeholder="Código EPI" required="">
                <span class="focus-border"> <i></i> </span>
            
            </label>
            <label class="label">
                
                <input type="number" formControlName="sGPTypeDeliveryId" name="QuantidadeEPI" id="QuantidadeEPI" class="input-bordas" placeholder="Quantidade EPI" required="">
                <span class="focus-border"> <i></i> </span>
            ...
            <label class="label">
                ...
                <input type="text" name="DescriçaoEPI" id="DescriçaoEPI" class="input-bordas" placeholder="Descrição EPI" required="">
                <span class="focus-border"> <i></i> </span>
