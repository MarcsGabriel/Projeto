...
$sql = "SELECT * FROM fornecedor ORDER BY cnpj DESC";
...
<div class="top-bar">
    ...
    <div class="tabelaEPI">
        <table class = "table">
            <thead>
                    <tr>
                        <th scope="col"><h3>CNPJ</h3></th>
                        <th scope="col"><h3>Nome Fantasia</h3></th>
                        <th scope="col"><h3>Tipo de Produto</h3></th>
                        <th scope="col"><h3>Contato</h3></th>
                        <th scope="col"></th>
                    </tr>
            </thead>
            <tbody>
                ...
                while($user_data = mysqli_fetch_assoc($result)){
                    echo"<tr>";
                    echo "<td align=\"center\">". $user_data['cnpj']."</td>";
                    echo "<td align=\"center\">". $user_data['nome']."</td>";
                    echo "<td align=\"center\">". $user_data['tpproduto']."</td>";
                    echo "<td align=\"center\">". $user_data['contato']."</td>";
                    echo "<td align=\"center\">
                    <a class='btn' href='EditFornecedor.php?id=$user_data[cnpj]'>
                    <img src='../img/editartexto.png' style='max-widht:20px; max-height:20px;'>
                    </a>
                    <a class='btn' href='DeleteFornecedor.php?id=$user_data[cnpj]'>
